...
class Resolver(ProxyResolver):
    def __init__(self,zone_file):
        print("resolver _init_")
        super().__init__( 53, 5)
        self.records = self.load_zones(zone_file)

    def zone_lines(self):
        print("resolver zone_lines")
        current_line = ''
...
if __name__ == '__main__':
    ...
    print("zone_file")
    zone_file = Path(os.getenv('ZONE_FILE', 'C:/Users/rita1/Desktop/פרויקט גמר/zones.txt'))
    print("resolver")
    resolver = Resolver(zone_file)
    print("udp")
